...
/**
 * Pantalla de Batalla Multijugador - Codicia (Piso 3)
 */
public class PantallaCodiciaMulti implements Screen {
    ...
    @Override
    public void show() {
        System.out.println("PantallaCodiciaMulti.show() ejecutado");
        ...
        if (hiloCliente == null || !hiloCliente.isConectado()) {
            System.out.println("PantallaCodiciaMulti: ERROR - No hay cliente conectado");
            estadoActual = EstadoBatallaMulti.ESPERANDO_CONEXION;
        } else {
            System.out.println("PantallaCodiciaMulti: Cliente conectado, esperando datos de batalla");
        ...
        if (Config.personajeSeleccionado == null) {
            System.out.println("PantallaCodiciaMulti: WARN - PersonajeSeleccionado es NULL.");
    ...
    private void parsearDatosBatalla(String datos) {
        ...
        try {
            ...
            // if (nivelRecibido < Config.nivel) return; // REMOVIDO: Bloqueaba reset de nivel en nuevo piso
    ...
    private Imagen crearSpriteEnemigo(String nombre) {
        ...
        if (nombre.equalsIgnoreCase("Guson")) {
            ...
            recurso = Recursos.ENEMIGOCODICIA2;
