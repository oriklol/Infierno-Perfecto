...
import com.dojan.infiernoperfecto.entidades.enemigos.fraude.EnemigoFraude1;
import com.dojan.infiernoperfecto.entidades.enemigos.fraude.EnemigoFraude2;
import com.dojan.infiernoperfecto.entidades.enemigos.fraude.MiniBossFraude;
...
public class PantallaFraude implements Screen {
    ...
    private void inicializarRecursos() {
        ...
        lugar = new Texto(Recursos.FUENTEMENU, 60, Color.RED, false);
    ...
    public void reiniciarNivel(int piso, int nivel) {
        ...
        if (nivel == 4) {
            // ========== NIVEL 4 = MINIBOSS ==========
            Enemigo miniboss = new MiniBossFraude();
            Imagen spriteMiniboss = new Imagen(Recursos.MINIBOSSFRAUDE);
            ...
            for (int i = 0; i < cantEnemigos; i++) {
                ...
                Imagen sprite;
                if (tipoEnemigo == 1) {
                    enemigo = new EnemigoFraude1();
                    sprite = new Imagen(Recursos.ENEMIGOFRAUDE1);
                } else {
                    enemigo = new EnemigoFraude2();
                    sprite = new Imagen(Recursos.ENEMIGOFRAUDE2);
                }
